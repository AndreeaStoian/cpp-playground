...
private:
	...
	std::vector<sf::Vertex> cell_vertices_new_gen;
	...
	int numberOfNeighbours(unsigned cell_x, unsigned cell_y);
	int isAlive(unsigned cell_x, unsigned cell_y);
public:
	/**
		Constructor.
	...
	*/
	...
	void setCellColor(unsigned cell_x, unsigned cell_y, sf::Color color, bool newGen=false);
	void updateWorld();
};